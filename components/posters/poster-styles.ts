...
import { WANTED_COLORS, AMBER_COLORS, POSTER_LAYOUT } from "@/lib/poster";

/**
 * Base styles shared by both poster types
 */
...
/**
 * Wanted poster specific styles (Red theme)
 */
...
/**
 * Amber alert specific styles (Amber/Yellow theme)
 */
