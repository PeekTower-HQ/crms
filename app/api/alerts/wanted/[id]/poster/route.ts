/**
 * Wanted Person Poster Generation API
 *
 * Endpoint: GET /api/alerts/wanted/[id]/poster
 * Query params:
...
/**
 * GET /api/alerts/wanted/[id]/poster
 * Generate a poster for a wanted person (PDF or image)
 */
export async function GET(
  ...
  try {
    ...
    // Generate poster
    const result = await container.posterService.generateWantedPoster(
      id,
      format,
      session.user.id,
      ipAddress
    ...
    console.error(`GET /api/alerts/wanted/[id]/poster error:`, error);
