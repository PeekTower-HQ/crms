...
async function main() {
  ...
  const wantedPerson = await prisma.person.upsert({
    ...
    update: {},
    create: {
      nationalId: "W7RGGVGI", // Real Sierra Leone NIN: 8 alphanumeric uppercase
      idType: "NIN",
      countryCode: "SLE",
      firstName: "Abdul",
      lastName: "Kamara",
  ...
  const missingPerson = await prisma.person.upsert({
    ...
    update: {},
    create: {
      nationalId: "A5K9M2P7", // Real Sierra Leone NIN: 8 alphanumeric uppercase
      idType: "NIN",
      countryCode: "SLE",
      firstName: "Mary",
      lastName: "Koroma",
  ...
  const cleanPerson = await prisma.person.upsert({
    ...
    update: {},
    create: {
      nationalId: "J8S4X1N3", // Real Sierra Leone NIN: 8 alphanumeric uppercase
      idType: "NIN",
      countryCode: "SLE",
      firstName: "James",
      lastName: "Sesay",
  ...
  const criminalPerson = await prisma.person.upsert({
    ...
    update: {},
    create: {
      nationalId: "H9B2M6F5", // Real Sierra Leone NIN: 8 alphanumeric uppercase
      idType: "NIN",
      countryCode: "SLE",
      firstName: "Hassan",
      lastName: "Bangura",
  ...
  const stolenToyota = await prisma.vehicle.upsert({
    ...
    create: {
      ...
      year: 2018,
      color: "Silver",
      ownerNIN: "K7P3N2M9", // Real Sierra Leone NIN: 8 alphanumeric uppercase
      ownerName: "John Doe",
      status: "stolen",
  ...
  const normalHonda = await prisma.vehicle.upsert({
    ...
    create: {
      ...
      year: 2020,
      color: "Blue",
      ownerNIN: "R5T8W1Q4", // Real Sierra Leone NIN: 8 alphanumeric uppercase
  ...
  const stolenNissan = await prisma.vehicle.upsert({
    ...
    create: {
      ...
      year: 2019,
      color: "Black",
      ownerNIN: "V9D6H3X2", // Real Sierra Leone NIN: 8 alphanumeric uppercase
  ...
  console.log("   Persons:");
  console.log("     - W7RGGVGI: ⚠️ WANTED (Abdul Hassan Kamara - high risk)");
  console.log("     - A5K9M2P7: ⚠️ MISSING (Mary Koroma)");
  console.log("     - J8S4X1N3: ✅ CLEAN (James Sesay)");
  console.log("     - H9B2M6F5: ⚠️ RECORD (Hassan Musa Bangura - 1 case)");
  console.log("\n   Vehicles:");
